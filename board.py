...
class Board:
    ...
    def draw_goban(self, win):
        ...
        pygame.draw.rect(win, BLACK, (PADDING+BOARD_SIZE, BOARD_OFFSET, BUTTON_WIDTH*2 + PADDING, 564), width=2)
        ...
        images = [tenuki, test, save, delete, undo, clear]
        positions = [
    ...
    def draw_tenuki_dot(self, win, colour):
    ...
    def check_captures(self, board, lastMove):
        ...
        def count_liberties(board, pos, liberties):
            ...
            if pos+19 <= 361: liberties += check_pieces(19, liberties)
    ...
    def draw_board(self, win, moves, TESTING):
        ...
        if TESTING == False:
            ...
            for joseki in newJosekiList:
                ...
                else: self.draw_tenuki_dot(win, POTENTIAL)